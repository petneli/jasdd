...
public class Settings {
    ...
    //client Events:
    public static final int REGISTER_EVENT= 0, LOGIN_EVENT= 1, ADDTOWISH_EVENT= 2;
    //Server Events:
    public static final int SUCCESS= 0, FAILURE= 1, ERROR= 2;



//    public final static String PATH_CATALOGUE = "/Users/nelipetkova/Desktop/Uni Stuff/DSE/catalogue.txt";
//    public final static String PATH_CUSTOMERS = "/Users/nelipetkova/Desktop/Uni Stuff/DSE/customers.txt";
